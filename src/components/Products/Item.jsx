    ...
    return (
            <>
             <Grid
              ...
              <Grid item xs={1}></Grid>
              <Grid item xs={4} md={4}>
                  {imgSrc &&(<Magnifier src={imgSrc} style={{width:'100%'}} />)}
                  {hasGallery && (
                      <Grid container >
                        <Gallery gallery={products.assets} changePhotoImg={changePhotoImg} />
                      </Grid>
                  )}
                </Grid>
                <Grid item xs={12} md={3} style={{padding:'20px'}}>
                  ...
                  <div className={classes.body} style={{textAlign:'justify'}} dangerouslySetInnerHTML={{ __html:products.description}} ></div>
                  { variants &&(
                    <Box sx={{minWidth:'20'}}>
                ...
                {!isNFT && (
                  <>
                    <p className={classes.regularText} style={{textAlign:'justify'}}>
                      <span className={classes.boldText}>{price}</span><br/>
                    </p>
